...
export default function AdminDashboardPage() {
  ...
  }, [isAuthenticated, selectedWorkshopId]);
  ...
  const fetchMasterData = async () => {
    ...
    if (allWorkshops && allWorkshops.length > 0) {
      ...
      // Default fallback track if database is empty
  ...
  // Active records calculations for the current workshop
    ...
    <div className="max-w-7xl mx-auto px-6 py-12 space-y-8">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none bg-[#12141a] border border-[#2c374d] text-neon font-mono text-xs font-bold py-2 pl-3 pr-8 rounded-lg outline-none focus:border-neon cursor-pointer"
            >
              {workshopsList.map((w) => (
          ...
          <div className="flex bg-[#121212] p-1 rounded-lg border border-[#242424]">
            <button
              ...
              className={`px-3 py-1.5 text-xs font-bold rounded-md font-mono transition-all cursor-pointer flex items-center gap-1.5 ${
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        ...
        <div className="bg-[#121212] border border-[#242424] p-4 rounded-xl space-y-1">
          ...
          <p className="text-xl font-black text-white font-mono">{activeCohortsCount} Batches ({batchCap}/batch)</p>
        </div>
      </div>
