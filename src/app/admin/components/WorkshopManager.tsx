    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-xs text-gray-400 font-mono">
            Manage fee, capacity per batch, public view links, and batch-wise WhatsApp links.
          </p>
        </div>
        <button
          onClick={handleAddNew}
          className="px-3.5 py-2 rounded-lg bg-neon text-black font-mono text-xs font-bold hover:bg-[#00cc52] transition-colors flex items-center gap-1.5 cursor-pointer shadow-[0_0_15px_rgba(0,255,102,0.2)]"
        >
          ...
          <form onSubmit={handleSave} className="space-y-4 text-xs font-sans">
            ...
            <div className="bg-[#0c0e14] border border-[#222a3a] p-4 rounded-xl space-y-3">
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="px-2.5 py-1 rounded bg-[#1c2436] hover:bg-neon hover:text-black font-mono text-[11px] text-gray-200 transition-colors"
                >
            ...
            <div className="flex justify-end gap-2 pt-2">
              <button
                ...
                className="px-4 py-2 rounded-lg bg-gray-800 text-gray-300 font-mono text-xs hover:bg-gray-700"
              >
                Cancel
              </button>
              <button
                type="submit"
                disabled={saving}
                className="px-5 py-2 rounded-lg bg-neon text-black font-bold font-mono text-xs hover:bg-[#00cc52] flex items-center gap-1.5 shadow-[0_0_15px_rgba(0,255,102,0.2)]"
              >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {workshops.map((w) => (
          <div
            key={w.id}
            className="bg-[#10131a] border border-[#202838] hover:border-neon/40 rounded-2xl p-5 space-y-4 transition-all"
          >
            ...
            <div className="bg-[#0b0e14] p-3 rounded-xl border border-[#1b2333] space-y-1.5 text-[11px] font-mono text-gray-400">
              ...
              <div className="text-neon flex items-center gap-1">
                ...
                <span>{(w.whatsapp_links || []).length} Batch WhatsApp Link(s) configured</span>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-2 border-t border-[#1e2636]">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-[#182030] hover:bg-neon hover:text-black text-gray-200 font-mono text-xs flex items-center gap-1.5 transition-colors"
              >
