    ...
    <div className="max-w-6xl mx-auto px-6 py-16 space-y-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 space-y-4">
          ...
          <div className="bg-[#0b0e14] border-2 border-[#1c2438] hover:border-neon/40 rounded-2xl p-6 space-y-3 font-mono text-xs shadow-xl transition-all">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 text-neon font-bold uppercase tracking-wider">
                <Mail className="w-4 h-4" />
                <span>Official Support Desk</span>
              </div>
              <span className="w-2 h-2 rounded-full bg-neon animate-pulse" title="Mail Active"></span>
            </div>
